---
title: '"TW-CRL:Time-Weighted Contrastive Reward Learning for Efficient Inverse Reinforcement Learning" Accepted to AAAI 2026 <span style="color:red, font-weight:bold">(Oral)</span>'
author: imec
group: recent
